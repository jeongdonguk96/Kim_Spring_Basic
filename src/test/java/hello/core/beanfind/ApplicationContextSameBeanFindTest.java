...
public class ApplicationContextSameBeanFindTest {
    ...
    void findBeanByName() {
        MemberRepository bean = context.getBean("memberRepository2", MemberRepository.class);
    ...
    void findAllBeanByType() {
        Map<String, MemberRepository> bean = context.getBeansOfType(MemberRepository.class);
